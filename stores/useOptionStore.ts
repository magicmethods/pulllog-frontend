export const useOptionStore = defineStore("option", () => {
    ...
    const rarityOptions = computed<SymbolOption[]>(() => [
        ...
        {
            symbol: "⭐",
            label: t("options.rarity.threeStars"),
            value: "3stars",
        },
    ])
    const symbolOptions = computed<SymbolOption[]>(() => [
        ...
        {
            symbol: "💖",
            label: t("options.symbol.guaranteed"),
            value: "guaranteed",
        },
    ])
    ...
    function getOptionsAs(
        ...
        if (type === "array") {
            switch (target) {
                ...
                case "symbol":
                    return markerLabels.value
                case "language":
                    return languageLabels.value
                case "theme":
                    return themeLabels.value
                case "homepage":
                    return homepageLabels.value
            }
        }
        switch (target) {
            case "rarity":
            ...
            case "symbol":
                return symbolOptions.value
            case "language":
                return languageOptions.value
            case "theme":
                return themeOptions.value
            case "homepage":
                return homepageOptions.value
        }
    }
