export default defineI18nLocale(async () => ({
    ...
    app: {
        ...
        description:
            "PullLog is a tool for managing gacha history and performing statistical analysis.",
    ...
    auth: {
        ...
        register: {
            ...
            confirmationEmailSent:
                "A confirmation email has been sent to the registered email address. Please click the link in the email to activate your account.",
        ...
        passwordReset: {
            ...
            confirmationEmailSent:
                "A password reset email has been sent to the registered email address. Please click the link in the email to reset your password.",
    ...
    validation: {
        ...
        appNameLengthExceeded:
            "Application name must be within {maxLength} characters",
    ...
    history: {
        ...
        historyStats: {
            ...
            expenseOnTarget: "Expense (target day)",
            noData: "No data available",
        },
        historyList: {
            date: "Date",
    ...
    stats: {
        ...
        chart: {
            expenseRatio: {
                ...
                totalLabel: "Total",
                currencyNote:
                    "Totals are grouped by currency. No FX conversion; pie shares use the recorded amounts as-is.",
                currencyNoteLong:
                    "When multiple currencies are present, totals are shown per currency. Exchange rates are not applied, and pie chart percentages are computed from the recorded amounts (expense_decimal). For like-for-like comparison, filter to a single currency or convert externally.",
            },
            monthlyExpenseStack: {
            ...
            rareDropBreakdown: {
                ...
                noticeLong:
                    "This breakdown only categorizes drops that match the preset marker definitions (e.g., Pickup, Lose the 50/50, Target, Guaranteed). Any custom markers defined by users are not recognized and will not appear in the statistics.",
            },
            rareDropRanking: {
                ...
                noticeLong:
                    "The ranking categorizes drops only by the preset marker definitions (e.g., Pickup, Lose the 50/50, Target, Guaranteed). Any custom markers defined by users are not recognized and will be grouped under 'Other'.",
            },
        },
        loading: {
    ...
    settings: {
        ...
        fileUpload: {
            invalidFileSize:
                "{file}: The file size exceeds the limit of {size}.", // primevue: ': Invalid file size, file size should be smaller than {1.}'
            invalidFileLimit:
                "Maximum number of files to be uploaded is {limit}.", // primevue: 'Maximum number of files to be uploaded is {0.}'
        ...
        notice: {
            ...
            inputErrorDetail:
                "There is an error in the input. Please check each item.",
    ...
    modal: {
        appEdit: {
            ...
            basicInfoDescription:
                "Set the registration details for the application handled by PullLog.",
            ...
            appDescriptionPlaceholder:
                "Description of the application, etc. (up to {maxLength} characters)",
            inputCharacterCount: "Input Character Count",
            ...
            dateUpdateTimeSync:
                "Sync Date Update Time with Log Registration Date",
            ...
            loggingSettingsDescription:
                "Define the application-specific settings and any markers to be used during logging in PullLog.",
        ...
        logConfirm: {
            ...
            confirmText:
                "Do you want to register the history with the following details?",
            appName: "Application Name",
            targetDate: "Target Date",
            totalPullCount: "Total Pull Count",
            highestRarityCount: "Highest Rarity Count",
            ...
            validationErrorMessage:
                "There are errors in the input. Please correct them.",
        ...
        deleteConfirm: {
            ...
            dangerNotice:
                "Warning: All data associated with this application will be deleted.",
            cancel: "Cancel",
            delete: "Delete",
        },
        export: {
            ...
            endDate: "End Date",
            dateRangeInvalid:
                "Start date and end date are not specified correctly",
        ...
        import: {
            ...
            overwriteDescription:
                "Existing history will be deleted and overwritten with the uploaded history.",
            mergeDescription:
                "Uploaded history will be added, and only overlapping data with existing history will be overwritten.",
            fileSizeInformation:
                "<b>{size}MB or less</b> in <b>{format1}</b> or <b>{format2}</b> format file can be uploaded.",
            cancel: "Cancel",
            upload: "Upload",
        },
        document: {
        ...
        shareImage: {
            title: "Export History Image",
            dismiss: "Close",
            range: "Output Period",
            rangeA: "Output Period (A)",
            rangeB: "Output Period (B)",
            checkA: "Latest History Trend",
            checkB: "App History Stats",
            size: "Image Size",
            ranges: {
                today: "Today",
                week1: "1 Week",
            ...
            imageTitle: "{appName} History ({targetDate})",
            chartATitle: "Latest History Trend ({range})",
            chartBTitle: "App History Stats ({range})",
            commit: "Download Image",
            cancel: "Cancel",
    ...
    component: {
        tooltip: {
            appName:
                'Application name can be freely set to a name that is easy for you to manage. <span class="tooltip-warning">※Application name is required</span>',
            ...
            appDesc:
                "You can freely enter a description of the application (up to {maxLength} characters).",
            appImage:
                "You can set any image you like as the image for this application. This image will take precedence over the icon image automatically retrieved from the specified URL.",
            currencyUnit:
                'Specify the currency unit to be used when charging the target application. For example, if in-game charges are made in Japanese yen, select "JPY".',
            dateUpdateTime:
                "This is the time when the date switches in the target application. Generally, crossing this time will recalculate the login date. <br>The set time can be synchronized with the update time of the target date at the time of log registration in PullLog.",
            pitySystem:
                "A pity system is a mechanism that guarantees a rare item drop after a certain number of attempts. You can specify whether this system is implemented and the number of attempts required to trigger it. <br>The configured details will be displayed as auxiliary lines in statistical graphs such as the trend of gacha attempts.",
            rarityDefs:
                "This is a list of rarity definitions used within the application. It serves as the initial list of rarity options for the drop list. <br>While you can add to this list when registering the drop list, it will not be updated in that case. <br>It is recommended to set this definition list for persistent use.",
            markerDefs:
                "This is a list of marker definitions for optionally marking during log recording of the PullLog drop list. It serves as the initial marker list for the drop list marking options. <br>While you can add to this list when registering the drop list, it will not be updated in that case. <br>It is recommended to set this definition list for persistent use.",
        },
        selectApps: {
            targetApps: "Target Applications",
            edit: "Edit",
        ...
        inputOptions: {
            helpText:
                "New definition values will be added to the end of the list.",
            maxItems: "A maximum of {count} definition values can be set.",
            maxLength:
                "Each definition value can be up to {count} characters long.",
    ...
    landing: {
        ...
        about: {
            ...
            description:
                "PullLog is a tool for managing and analyzing your gacha history.",
            features: "Features",
            feature1: "Easy Gacha History Management",
            feature1Desc:
                "Effortlessly manage your gacha pulls and history with our intuitive interface.",
            feature2: "Detailed Statistics and Analysis",
            feature2Desc:
                "Gain insights into your gacha performance with detailed statistics and analysis tools.",
            feature3: "User-Friendly Interface",
            feature3Desc:
                "Enjoy a user-friendly interface designed for easy navigation and management.",
            feature4: "Multi-Platform Support",
            feature4Desc:
                "Access PullLog from any device, whether it’s a desktop, tablet, or smartphone.",
        ...
        gallery: {
            ...
            description:
                "Explore the features and interface of PullLog through our gallery.",
        ...
        steps: {
            ...
            description:
                "Follow these simple steps to start using PullLog and manage your gacha history effectively.",
            prev: "Previous Step",
            next: "Next Step",
            step1: {
                ...
                imageCaption: "",
                description:
                    "After drawing a gacha, launch PullLog to record your gacha history.",
            },
            step2: {
                title: "Select the Application",
                imageCaption: "",
                description:
                    "Select the application you want to manage from the list of registered applications.",
            },
            step3: {
                title: "Record Gacha History",
                imageCaption: "",
                description:
                    "You can easily record how to draw gacha and your history with just a few clicks.",
            },
            step4: {
                title: "Stats Are Automatically",
                imageCaption: "",
                description:
                    "Aggregated data and graphs are automatically generated and can be viewed at any time.",
            },
        },
        statistics: {
            ...
            description:
                "PullLog offers detailed analysis of your gacha history and spending, enabling you to objectively understand your trends and probability outcomes.",
            stat1: {
                title: "Expense Ratio",
                //describe: 'See how your total spending is distributed across different games and apps.'
                describe:
                    "Aggregate spending by app and visualize its proportion of the total.",
            },
            stat2: {
                title: "Monthly Spending",
                //describe: 'Visualize your monthly expenses and spot spending patterns at a glance.'
                describe:
                    "Display monthly expenditures in chronological order to review spending trends.",
            },
            stat3: {
                title: "Luck Trend",
                //describe: 'Track your luck over time and see how your rare drop rate changes across pulls.'
                describe:
                    "Calculate rare drop rates over time and objectively track fluctuations in luck.",
            },
            stat4: {
                title: "Pull Counts & Rare Rates",
                //describe: 'Check total pulls, rarity counts, and the actual probability compared with expected rates.'
                describe:
                    "Compare total pulls and actual rare rates against expected probabilities.",
            },
            stat5: {
                title: "Rare Drop Breakdown Ratio",
                //describe: 'Analyze rare drops by categories such as pickups, guaranteed slots, and more.'
                describe:
                    "Classify rare drops into categories such as pickups and guaranteed slots.",
            },
            stat6: {
                title: "Rare Drop Ranking",
                //describe: 'Rank your rarest acquisitions to see which items or characters you’ve pulled most often.'
                describe:
                    "Display frequently pulled rare items in a ranking format.",
            },
            stat7: {
                title: "History Trend",
                //describe: 'Review your entire gacha history to understand long-term patterns and milestones.'
                describe:
                    "Review long-term patterns and key milestones across your entire gacha history.",
            },
        },
        footer: {
            contactUs: "Contact Us",
            contactDesc:
                "If you have any questions, concerns, or issues regarding the service, please contact support@pulllog.net and provide your registered email address.",
            privacyPolicy: "Privacy Policy",
    ...
    cookieConsent: {
        ...
        description:
            "This site uses cookies to analyze and improve user experience.",
        ...
        requiredCookiesDesc:
            "Cookies that are essential for the basic functionality of the site. Opting out is not possible.",
