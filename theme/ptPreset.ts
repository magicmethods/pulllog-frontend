export const ptPreset = {
    ...
    Breadcrumb: {
        ...
        separator:
            "relative bg-transparent top-[1px] text-surface-300 dark:text-gray-600",
    },
    ...
    ToggleButton: {
        ...
        content:
            "flex items-center justify-center m-0 p-1 rounded-md bg-primary-500 dark:bg-primary-700 hover:bg-primary-400/40 dark:hover:bg-primary-500/40",
    ...
    DatePicker: {
        ...
        selectMonth:
            "mr-0.5 px-3 py-2 rounded hover:bg-surface-200/50 hover:text-primary disabled:text-surface-600/50 dark:hover:bg-gray-700/40",
        selectYear:
            "ml-0.5 px-3 py-2 rounded hover:bg-surface-200/50 hover:text-primary disabled:text-surface-600/50 dark:hover:bg-gray-700/40",
        ...
        tableHeaderRow:
            "text-sm font-semibold text-surface-500 border-b border-surface bg-surface-200/50 dark:bg-gray-700/40",
        tableHeaderCell:
            "w-1/7 py-1 border-r border-surface text-center last:border-0 first:bg-rose-200/50 first:dark:bg-rose-600/40 last:bg-blue-200/50 last:dark:bg-blue-600/40",
        tableBodyRow:
            "text-sm font-semibold text-surface-500 border-b border-surface last:border-0",
        dayCell:
            "w-1/7 p-0 border-r border-surface text-center last:border-0 hover:bg-primary-200/50 hover:text-primary disabled:text-surface-600/50 dark:hover:bg-gray-700/40",
        day: {
        ...
        buttonbar:
            "flex items-center justify-between p-1 rounded-b-md border-t border-surface-200 dark:border-gray-700 dark:bg-gray-950",
        pcTodayButton: {
    ...
    Select: {
        ...
        overlay:
            "max-w-[calc(100%_-_20px)] md:max-w-[calc(40%_-_2rem)] mt-0 border border-surface-300 rounded shadow-lg dark:border-gray-700",
        ...
        clearIcon:
            "border rounded-full border-surface-400 bg-surface-100 text-surface-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 hover:bg-surface-200 dark:hover:bg-gray-600 w-4 h-4 p-0.5 right-8 -translate-y-1/2",
        dropdown:
            "max-w-max bg-white border-surface dark:bg-gray-950 dark:border-gray-700",
        dropdownIcon: "text-surface-400 hover:text-primary-500",
        emptymessage:
            "py-2 px-3 text-surface-400 dark:text-gray-400/50 select-none",
    },
    ...
    MultiSelect: {
        ...
        pcChip: {
            ...
            removeIcon:
                "text-surface-500 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-500",
        },
        dropdown:
            "-mr-1 text-surface-400 hover:text-primary-500 dark:text-gray-400 dark:hover:text-primary-500",
        overlay:
            "w-[calc(100%_-_20px)] md:w-80 mt-0 border border-surface-300 dark:border-gray-700 rounded shadow-lg bg-white dark:bg-gray-950",
        listContainer: "p-2",
        ...
        emptyMessage:
            "py-2 text-surface-400 dark:text-gray-600 select-none text-sm",
    },
    ...
    Drawer: {
        ...
        pcCloseButton: {
            root: "mt-2 border-0 outline-0 rounded-full hover:bg-surface-200/40 dark:hover:bg-gray-700/40 hover:text-primary-600 dark:hover:text-primary-400 z-10!",
        },
    ...
    FileUpload: {
        ...
        content:
            "flex-grow min-h-[7rem] p-4 border-l border-surface-300 dark:border-gray-800 flex flex-col justify-center items-start",
        pcProgressBar: {
        ...
        fileInfo: "text-sm",
        pcFileBadge: {
            root: "px-2 rounded-full text-xs bg-amber-400 text-surface-600 dark:bg-yellow-600 dark:text-white",
        },
        pcFileRemoveButton: {
            root: "rounded-full text-surface-400 dark:text-gray-600 hover:text-primary-500 dark:hover:text-primary-400 bg-transparent hover:bg-surface-100 dark:hover:bg-gray-800/40",
        },
    ...
    Menu: {
        ...
        list: "w-max p-2",
        submenuLabel:
            "font-semibold text-sm p-1 text-surface-400 dark:text-gray-500",
        item: "flex justify-start items-baseline w-full gap-2 text-sm text-surface-700 dark:text-gray-200",
        itemContent:
            "w-full p-2 rounded hover:bg-primary-50 dark:hover:bg-primary-950 hover:text-primary-700 dark:hover:text-primary-400",
    ...
    Card: {
        ...
        caption:
            "mb-auto shrink text-base font-semibold text-primary-600 dark:text-primary-500",
